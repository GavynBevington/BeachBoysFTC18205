...
//        encoderDrive(DRIVE_SPEED, 55, 55, 3);
          encoderDrive(DRIVE_SPEED, -65, -65, 2);
          telemetry.addData("Distance from goal", distanceSensor.getDistance(DistanceUnit.CM));
          telemetry.update();
          ...
          while (opModeIsActive() && distanceSensor.getDistance(DistanceUnit.CM) >= 10) {
              telemetry.addData("While loop distance", distanceSensor.getDistance(DistanceUnit.CM));
              telemetry.update();
              hardware.FrontLeftMotor.setPower(DRIVE_SPEED);
              hardware.FrontRightMotor.setPower(DRIVE_SPEED);
              hardware.RearRightMotor.setPower(DRIVE_SPEED);
              hardware.RearLeftMotor.setPower(DRIVE_SPEED);
          }
